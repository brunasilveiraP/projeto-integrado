<template>
    <div class="flex-grow-1">
        <h2 class="bbl-orange--text">Tipos de Anexo</h2>
...
import ModalTipoAnexo from "@/views/tipoAnexo/modal/modalTipoAnexo.vue";
...
export default {
    ...
    methods: {
        ...moduleTipoAnexo.mapActions(["getAll", "create", "delete", "getById"]),
    ...
    mixins: [
        SearchFilters,        
        DataTable({ store: "ModuleTipoAnexo" }),
    ]
}

            ...
            <div class="my-4 d-flex flex-row">
                ...
                >
                    <div class="d-flex" style="width: 100%">
                        <v-select
                            v-show="inputData.roleName !== 'Admin'"
                            :items="parceiros"
                            item-value="id"
                            item-text="fantasia"
                            v-model="parceiro"
                            label="Parceiro"
                            :disabled="this.isTenant"
...
export default {
    ...
    name: 'modalParceiroSelectCobranca',
    ...
    methods: {
        ...
        ...moduleCobranca.mapActions(["create",]),
        ...
        async getParceiros(){
            if(this.$store.state.Session.tenant != null){
                this.parceiros.push(await this.getByIdParceiro(this.$store.state.Session.tenant.id));

            ...
            <v-card >
                ...
                <v-card-text id="print-card-text">
                    ...
                    <v-row class="justify-center">
                        ...
                        <v-col cols="3" class="textBold">Cliente</v-col>
                        <v-col cols="2" class="textBold">Concessionaria</v-col>
                        <v-col cols="2" class="textBold">Fase</v-col>
                    ...
                    <v-row v-if="itens" v-for="item in itens" :key="item.valor" class="justify-center">
                        ...
                        <v-col cols="3" class="borderBottom">{{item.clienteNome}}</v-col>
                        <v-col cols="2" class="borderBottom">{{item.concessionariaNome}}</v-col>
                        <v-col cols="2" class="borderBottom">{{item.faseNome}}</v-col>
                        <v-col cols="2" class="borderBottom">{{ formatarMoedaMask(item.valor) }}</v-col>
                    </v-row>

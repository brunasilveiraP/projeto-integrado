<template>
    <div class="flex-grow-1">
        <h2 class="bbl-orange--text">Fases</h2>
...
import ModalFase from "@/views/fase/modal/modalFase.vue";
...
export default {
    ...
    methods: {
        ...moduleFase.mapActions(["getAll", "create", "delete", "getById"]),

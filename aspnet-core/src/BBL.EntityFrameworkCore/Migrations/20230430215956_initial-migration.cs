        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncluiCobranca = table.Column<bool>(type: "bit", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KwpInicial = table.Column<long>(type: "bigint", nullable: false),
                    KwpFinal = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoAnexos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnderecoId = table.Column<int>(type: "int", nullable: true),
                    PagaTrt = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpTenants_Enderecos_EnderecoId",
                        column: x => x.EnderecoId,
                        principalTable: "Enderecos",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CheckedToChangePassword = table.Column<bool>(type: "bit", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cobrancas_AbpTenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AbpTenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dia = table.Column<long>(type: "bigint", maxLength: 31, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiasPagamento", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiasPagamento_AbpTenants_ParceiroId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParceiroTabelaPrecos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParceiroTabelaPrecos_AbpTenants_ParceiroId",
                        column: x => x.ParceiroId,
                        principalTable: "AbpTenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParceiroTabelaPrecos_TabelaPrecos_TabelaPrecoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FabricanteInversor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModeloInversor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PotenciaInversor = table.Column<double>(type: "float", nullable: false),
                    FabricanteModulo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModeloModulo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QuantidadeModulo = table.Column<int>(type: "int", nullable: false),
                    PotenciaModulo = table.Column<double>(type: "float", nullable: false),
                    TipoGeracao = table.Column<int>(type: "int", nullable: false),
                    TipoAterramento = table.Column<int>(type: "int", nullable: false),
                    NumeroPosteUc = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumeroTransformador = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumeroUc1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PercentualUc1 = table.Column<double>(type: "float", nullable: false),
                    NumeroUc2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PercentualUc2 = table.Column<double>(type: "float", nullable: false),
                    ...
                    ValorTrt = table.Column<double>(type: "float", nullable: true),
                    StatusPagamentoTrt = table.Column<int>(type: "int", nullable: true),
                    TenantId = table.Column<int>(type: "int", nullable: false),
                    DataCriacao = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DataHomologacao = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projetos_AbpTenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AbpTenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projetos_Cobrancas_CobrancaId",
                        column: x => x.CobrancaId,
                        principalTable: "Cobrancas",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projetos_Concessionarias_ConcessionariaId",
                        column: x => x.ConcessionariaId,
                        principalTable: "Concessionarias",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projetos_Fases_FaseId",
                        column: x => x.FaseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Anexos_TipoAnexos_TipoAnexoId",
                        column: x => x.TipoAnexoId,
                        principalTable: "TipoAnexos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Observacao_Projetos_ProjetoId",
                        column: x => x.ProjetoId,
                        principalTable: "Projetos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiasPagamento_ParceiroId",
                table: "DiasPagamento",
                column: "ParceiroId");

            migrationBuilder.CreateIndex(
                name: "IX_Observacao_ProjetoId",
                table: "Observacao",
                column: "ProjetoId");

            migrationBuilder.CreateIndex(
                name: "IX_ParceiroTabelaPrecos_ParceiroId",
                table: "ParceiroTabelaPrecos",
                column: "ParceiroId");

            migrationBuilder.CreateIndex(
                name: "IX_ParceiroTabelaPrecos_TabelaPrecoId",
                table: "ParceiroTabelaPrecos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projetos_CobrancaId",
                table: "Projetos",
                column: "CobrancaId");

            migrationBuilder.CreateIndex(
                name: "IX_Projetos_ConcessionariaId",
                table: "Projetos",
                column: "ConcessionariaId");

            migrationBuilder.CreateIndex(
                name: "IX_Projetos_FaseId",
                table: "Projetos",
                column: "FaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Projetos_TenantId",
                table: "Projetos",
                column: "TenantId");

...
{
    public abstract class BBLWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BBLWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BBLWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BBLDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BBLDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BBLDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BBLDbContext, Task<T>> func)
        {
            T result;
